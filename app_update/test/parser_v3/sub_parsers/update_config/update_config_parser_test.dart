...
import 'package:app_update/src/parser/sub_parsers/update_config/update_config_parser.dart';
import 'package:app_update/src/parser/sub_parsers/update_config/update_config.dart';
...
void main() {
  group('UpdateConfigParser (интеграционный)', () {
    ...
    test('Парсинг большого конфига из api_v3.yaml', () async {
      final yamlStr =
          await File('test/parser_v3/sub_parsers/update_config/api_v3.yaml').readAsString();
