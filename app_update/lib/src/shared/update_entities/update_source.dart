...
class UpdateSource extends UpdateEntity {
  ...
  static const appStore = UpdateSource._('appStore', platforms: [UpdatePlatform.ios, UpdatePlatform.macos]);
  static const testFlight = UpdateSource._('testFlight', platforms: [UpdatePlatform.ios, UpdatePlatform.macos]);
